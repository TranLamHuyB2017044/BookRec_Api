...
class CartItems extends Cart{
    ...
    static async getCartItems(cart_id){
        ...
        const itemsQuery = `SELECT b.book_id, ct.item_id, c.thumbnail_url, b.title, ct.quantity, b.original_price FROM cartitem ct ${book_query} ${cover_book_query} where ct.cart_id = ?`;
