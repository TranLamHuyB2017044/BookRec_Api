...
class Promotions {
    ...
    static async getBookPromotions(book_id) {
        ...
        const query = `select ${select_query} from book_promotions bp join promotions p on bp.promotion_id = p.promotion_id ${book_query} ${cover_book_query} where  bp.book_id = ? `
